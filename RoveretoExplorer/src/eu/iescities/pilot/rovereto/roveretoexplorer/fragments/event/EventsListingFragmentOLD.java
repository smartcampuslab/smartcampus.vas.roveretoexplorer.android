...
public class EventsListingFragmentOLD extends AbstractLstingFragment<LocalEventObject> implements TagProvider {
	...
	private EventAdapterOLD eventsAdapter;
	...
	public void onActivityCreated(Bundle arg0) {
		...
		if (eventsAdapter == null) {
			eventsAdapter = new EventAdapterOLD(context, R.layout.events_row, postProcAndHeader);
		}
	...
	private void removeEvent(EventAdapterOLD eventsAdapter, Integer indexAdapter) {
	...
	private List<LocalEventObject> getEvents(AbstractLstingFragment.ListingRequest... params) {
		return Utils.getFakeLocalEventObjects();
	}
