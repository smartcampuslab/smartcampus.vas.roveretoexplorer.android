...
public class Fragment_EvDetail_Info_Contacts extends Fragment {
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		if (mEvent.getContacts().containsKey("phone")) {
			List<String> telephones = (List<String>) mEvent.getContacts().get("phone");
			// String[] telList = (String[])
			// mEvent.getContacts().get("telefono");
		...
		if (mEvent.getContacts().containsKey("email")) {
			...
			List<String> emails = (List<String>) mEvent.getContacts().get("email");
		...
		modifyBtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View view) {
				...
				// String[] newtels = (String[])
				// mEvent.getContacts().get("telefono");
				// //Log.i("FRAGMENT LC", "number of events: " +
				// Utils.appEvents.size());
				...
				if (isValidInput()) {
					...
					// Map<String,Object> contacts = new HashMap<String,
					// Object>();
					// contacts.put("telefono", new
					// String[]{txtPhone.getText().toString()});
					// contacts.put("email", new
					// String[]{txtEmail.getText().toString()});

					mEvent.getContacts().put("telefono", new String[] { txtEmail.getText().toString() });
					...
					new SCAsyncTask<ExplorerObject, Void, Boolean>(getActivity(), new UpdateEventProcessor(
							getActivity())).execute(mEvent);
	...
	private boolean isValidInput() {
		...
		if ((txtPhone.getText().toString().matches(""))
				|| (PhoneNumberUtils.isGlobalPhoneNumber(txtPhone.getText().toString()))) {
			validPhone = true;
		} else
			Toast.makeText(getActivity(), getResources().getString(R.string.invalid_phone), Toast.LENGTH_SHORT).show();

		if ((txtWebsite.getText().toString().matches(""))
				|| (txtWebsite.getText().toString().matches(getResources().getString(R.string.start_url)))
				|| (Utils.isValidUrl(txtWebsite.getText().toString()))) {
			validWebUrl = true;
		} else
			Toast.makeText(getActivity(), getResources().getString(R.string.invalid_weburl), Toast.LENGTH_SHORT).show();

		if ((txtFacebook.getText().toString().matches(""))
				|| (txtFacebook.getText().toString().matches(getResources().getString(R.string.start_url)))
				|| (Utils.isValidUrl(txtFacebook.getText().toString()))) {
			validFBUrl = true;
		} else
			Toast.makeText(getActivity(), getResources().getString(R.string.invalid_fburl), Toast.LENGTH_SHORT).show();

		if ((txtTwitter.getText().toString().matches(""))
				|| (txtTwitter.getText().toString().matches(getResources().getString(R.string.start_url)))
				|| (Utils.isValidUrl(txtTwitter.getText().toString()))) {
			validTwitterUrl = true;
		} else
			Toast.makeText(getActivity(), getResources().getString(R.string.invalid_twitterurl), Toast.LENGTH_SHORT)
					.show();
