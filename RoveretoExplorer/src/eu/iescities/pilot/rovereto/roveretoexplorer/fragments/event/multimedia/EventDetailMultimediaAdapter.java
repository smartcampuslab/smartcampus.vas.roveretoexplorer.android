...
import eu.iescities.pilot.rovereto.roveretoexplorer.custom.data.model.Multimedia;
...
public class EventDetailMultimediaAdapter extends ArrayAdapter<Multimedia> {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		RoveretoExplorerApplication.imageLoader.displayImage(multimedia.getThumbnailUrl(), holder.multimediaThumbnail);
