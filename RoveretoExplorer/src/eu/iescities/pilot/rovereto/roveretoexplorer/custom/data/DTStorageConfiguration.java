...
public class DTStorageConfiguration implements StorageConfiguration {
	...
	private static Class<? extends BasicObject>[] classes = (Class<? extends BasicObject>[])new Class<?>[]{ExplorerObject.class};												
	private static BeanStorageHelper<ExplorerObject> eventHelper = new EventStorageHelper();
	@Override
	...
	public String getTableName(Class<? extends BasicObject> cls) throws StorageConfigurationException {
		...
		if (cls.equals(ExplorerObject.class)) {
			return "events";
		}
